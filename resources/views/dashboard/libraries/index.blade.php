...
@section('content')
    ...
    <div class="btn-group btn-group-justified m-b-10">
        <a href="#add" class="btn btn-success waves-effect btn-lg waves-light" data-animation="fadein" data-plugin="custommodal"
           data-overlaySpeed="100" data-overlayColor="#36404a">اضافة مكتبة <i class="fa fa-plus"></i> </a>
                ...
                <table id="datatable" class="table table-bordered table-responsives">
                    ...
                    @foreach($libraries as $library)
                        <tr>
                            <td>
                                <label class="custom-control material-checkbox" style="margin: auto">
                                    <input type="checkbox" class="material-control-input checkSingle" id="{{$library->id}}">
                                    <span class="material-control-indicator"></span>
                                </label>
                            </td>
                            <td><img src="{{appPath()}}/images/users/{{$library->avatar}}" alt="user-img" width="60px" title="Mat Helme" class="img-circle img-thumbnail img-responsive"></td>
                            <td>{{$library->name}}</td>
                            <td>{{$library->email}}</td>
                            <td>{{$library->phone}}</td>
                            <td>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="nope" name="name" required class="form-control" placeholder="اسم المكتبة">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="field-1" class="control-label">الاسم</label>
                            <input type="text" autocomplete="nope" name="edit_name" value="" required class="form-control" placeholder="اسم المكتبة">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="field-2" class="control-label">رقم الهاتف</label>
                            <input type="text" autocomplete="nope" name="edit_phone" value="" required class="phone form-control" id="phone" placeholder="رقم الهاتف">
                        </div>
                    </div>
                </div>
                <div class="row">
    ...
    <div id="contact" class="modal-demo">
        ...
        <h4 class="custom-modal-title" style="background-color: #36404a">التواصل مع المكتبة</h4>
    ...
    <div id="delete" class="modal-demo" style="position:relative; right: 32%">
        ...
        <h4 class="custom-modal-title">حذف المكتبة</h4>
